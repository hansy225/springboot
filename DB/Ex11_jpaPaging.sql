...
insert into jpapaging values( jpapaging_seq.nextval, 'user10@test.com', 'user17');
insert into jpapaging values( jpapaging_seq.nextval, 'user11@test.com', 'user18');
insert into jpapaging values( jpapaging_seq.nextval, 'user12@test.com', 'user19');
insert into jpapaging values( jpapaging_seq.nextval, 'user13@test.com', 'user20');
insert into jpapaging values( jpapaging_seq.nextval, 'user14@test.com', 'user21');
insert into jpapaging values( jpapaging_seq.nextval, 'user15@test.com', 'user22');
insert into jpapaging values( jpapaging_seq.nextval, 'user16@test.com', 'user23');
insert into jpapaging values( jpapaging_seq.nextval, 'user15@test.com', 'user24');
